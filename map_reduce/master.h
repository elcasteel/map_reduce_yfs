...
unsigned calls;
time_t start_time;
void start_mappers(std::string mapper_dir);
void start_reducers(std::string reducer_dir);
std::string my_dir;
...
//input_reader reader;
virtual input_reader* get_input_reader(std::string input_dir,std::string output_dir)=0;
...
protected:
   input_reader* get_input_reader(std::string input_dir,std::string output_dir);
